## keymap generation steps

1. use [keymap-drawer.streamlit.app](https://keymap-drawer.streamlit.app/) or setup from [github](https://github.com/caksoylar/keymap-drawer)
2. import `.keymap` and parse using zmk option
3. rename keyboard to `corne`
4. upload `.dtsi` file in custom layout
5. paste raw config from below into config section
6. replace transparent keys to `⠀` invisible unicode
